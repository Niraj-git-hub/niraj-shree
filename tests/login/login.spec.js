...
test('Login test with valid credentials both', async ({ page }) => {
    ...
    await page.locator('.hdt-site-nav_icon.hdt-site-nav_user > .hdt-inline-flex').first().click()
    await page.locator('//input[@id="CustomerEmail-customer-login-modal-0"]').fill("niraj.stha2061@gmail.com")
    await page.locator('//input[@id="CustomerPassword-customer-login-modal-0"]').fill('shreeyan123')
